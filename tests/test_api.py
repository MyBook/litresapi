...
def test_get_cover(litres):
    response = litres.get_cover(file_id='32544407', file_ext='jpg')
...
def test_get_cover_from_book(litres):
    response = litres.get_cover(book={'@file_id': '32544407', '@cover': 'jpg'})
...
def test_not_cover_for_book(litres):
    response = litres.get_cover(book={'@file_id': '32544407', '@cover': ''})
